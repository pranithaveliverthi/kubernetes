...
### 1. Reporting Issues
- Use our [issue template](https://github.com/pranithaveliverthi/kubernetes/issues/new/choose)
- Clearly describe:
...
- Start a [discussion](https://github.com/pranithaveliverthi/kubernetes/discussions/new?category=ideas)
- Follow format:
  ```markdown
  ## Proposed Topic
  ### Why Important?
...
- Receive social media shoutouts (@pranithaveliverthi)
...
🙌 Ready to contribute? [Find Good First Issues](https://github.com/pranithaveliverthi/kubernetes/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
