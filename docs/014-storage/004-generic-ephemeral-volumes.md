...
:::tip
Use the [manifest templates](https://github.com/pranithaveliverthi/kubernetes/tree/main/docs/014-storage/manifests) to create your own Kubernetes resources which can be used in the examples below.
:::
