...
:::tip
Use the [manifest templates](https://github.com/pranithaveliverthi/kubernetes/tree/main/docs/001-eks-guides/manifests) to create your own Kubernetes resources which can be used in the examples below.
:::

:::tip
Use the [Cloud Formation templates](https://github.com/pranithaveliverthi/kubernetes/tree/main/docs/001-eks-guides/cloudformation) to create your own AWS resources which can be used in the examples below.
:::
