...
### [GitHub Repository | Source Code ](https://github.com/pranithaveliverthi/EKS-Troubleshooting-AI-Assistant)   
...
```bash
# Clone & Initialize
https://github.com/pranithaveliverthi/EKS-Troubleshooting-AI-Assistant
cd infra/terraform 
./install.sh 
```
