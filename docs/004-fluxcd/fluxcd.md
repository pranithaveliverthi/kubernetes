...
spec:
  url: https://github.com/pranithaveliverthi/kubernetes
  ref:
    branch: fluxcd
  interval: 1m
```
...
```bash
flux create secret git app2-githubsecret --url https://github.com/pranithaveliverthi/kubernetes --username '' --password '' --namespace fluxcd-demo
```  
...
- [📂 Example Repository](https://github.com/pranithaveliverthi/kubernetes/)  
