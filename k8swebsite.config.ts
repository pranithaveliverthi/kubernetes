...
const config: Config = {
  ...
  url: 'https://pranithaveliverthi.com',
  ...
  organizationName: 'pranithaveliverthi', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/pranithaveliverthi/kubernetes/tree/dev/',
        },
        blog: {
  ...
  plugins: [
    [
      '@docusaurus/plugin-content-docs',
      {
        ...
        editUrl: 'https://github.com/pranithaveliverthi/kubernetes/tree/dev/',
      },
    ],
    [
      '@docusaurus/plugin-content-docs',
      {
        ...
        editUrl: ({ docPath }) =>
          `https://github.com/pranithaveliverthi/aws/tree/main/docs/${docPath}`, // Correct edit URL
  ...
  themeConfig: {
    announcementBar: {
      ...
      content:
        '⭐️ If you like this project, give it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/pranithaveliverthi/kubernetes">GitHub</a> and follow me on <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/pranithaveliverthi/">LinkedIn</a> ⭐️',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/pranithaveliverthi/kubernetes',
          label: 'GitHub',
          position: 'right',
        },
        {
        ...
        },
        {
          ...
          value: `<a href="https://github.com/pranithaveliverthi/kubernetes/releases/tag/${version}" target="_blank" rel="noopener noreferrer" class="navbar-version">Version ${version}</a>`, // Use a link with a custom class
        },
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/in/pranithaveliverthi/',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/pranithaveliverthi',
            },
          ],
        },
      ],
