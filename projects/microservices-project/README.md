...
| `DOCKERHUB_USERNAME` | Your Docker Hub username | `pranithaveliverthi` |
...
```bash
kubectl set image deployment/frontend frontend=pranithaveliverthi/microservices-demo-frontend:v1.2.3 -n microservices
```
...
**Anvesh Muppeda**
- GitHub: [@pranithaveliverthi](https://github.com/pranithaveliverthi)
- Docker Hub: [pranithaveliverthi](https://hub.docker.com/u/pranithaveliverthi)
